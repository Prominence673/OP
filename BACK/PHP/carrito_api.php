...
// Buscar o crear carrito activo para el usuario
$carrito_id = null;
...
// Buscar id_producto en productos (pivot)
$stmt = $conn->prepare("SELECT id_producto FROM productos WHERE tipo=? AND id_referencia=? LIMIT 1");
